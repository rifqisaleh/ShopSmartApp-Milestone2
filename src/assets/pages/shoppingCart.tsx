...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 mb-32 mt-32 rounded-lg shadow-lg bg-urbanChic-100">
      <h1 className="text-4xl text-urbanChic-600 mb-4 text-center">Shopping Cart</h1>
      {cart.length === 0 ? (
